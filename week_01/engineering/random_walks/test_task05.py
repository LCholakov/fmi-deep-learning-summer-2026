import unittest
import numpy as np
from task04 import get_my_rng, get_int_1to6, get_next_move, get_one_walk, get_five_walks
...
class TestGetFiveWalks(unittest.TestCase):
    def test_when_called_with_rng_then_returns_five_walks(self):
        rng = np.random.default_rng(1)
        walks = get_five_walks(rng)
